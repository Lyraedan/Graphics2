...
void SceneNodePhysicsCube::Tick(XMMATRIX completeMatrix) {

	// Weird jump bug?
	//aabb.SetPosition(xPos, yPos, zPos);

	// Equation = (Position * ChunkSize) / TileScale
...
void SceneNodePhysicsCube::Render()
{
...
void SceneNodePhysicsCube::BuildGeometry() {
...
void SceneNodePhysicsCube::BuildConstantBuffer()
{
...
void SceneNodePhysicsCube::BuildVertexLayout()
{
...
void SceneNodePhysicsCube::BuildShaders() {
...
void SceneNodePhysicsCube::BuildTexture()
{
...
void SceneNodePhysicsCube::AddVertex(XMFLOAT3 position, XMFLOAT3 normals, XMFLOAT2 uv)
{
